...
var particles1, particles2,particles3,particles4,particles5,particles6;
...
function draw() {
  ...
  rect(block1.position.x,plane.position.y,150,20);
  rect(block2.position.x,plane.position.y,150,20);
